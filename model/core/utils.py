...
def get_optimizer(opt_algo, learning_rate):
...
def get_sync_optimizer(opt_algo, learning_rate, all_workers):
    ...
    return tf.train.SyncReplicasOptimizer(opt,
            replicas_to_aggregate = int(all_workers *2/3),
            total_num_replicas = all_workers)
